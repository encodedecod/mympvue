<template>
  <div class="goods">
    <div class="swiper">
      <swiper class="swiper-container" indicator-dots="true" autoplay="true" interval="3000" circular="true" duration="1000">
    ...
    <div class="detail" v-if="goods_desc">
      <!-- 富文本编辑器预览 -->
      <wxParse :content="goods_desc" :key="id"/>
    </div>
...
export default {
  ...
  // 商品分享onShareAppMessage微信分享专门的api
  onShareAppMessage() {
